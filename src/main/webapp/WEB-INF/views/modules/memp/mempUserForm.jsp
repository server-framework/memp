...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/memp/mempUser/">用户列表</a></li>
		<li class="active"><a href="${ctx}/memp/mempUser/form?id=${mempUser.id}">用户<shiro:hasPermission name="memp:mempUser:edit">${not empty mempUser.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="memp:mempUser:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="mempUser" action="${ctx}/memp/mempUser/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="memp:mempUser:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
